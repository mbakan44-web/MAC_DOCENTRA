...
namespace Docentra_Mac.Views.Pages
{
    public partial class DeletePagesPage : UserControl
    {
        ...
        {
            if (string.IsNullOrEmpty(_selectedFile) || string.IsNullOrWhiteSpace(RangeInput.Text))
                return;
            ...
            var file = await topLevel.StorageProvider.SaveFilePickerAsync(new FilePickerSaveOptions
            {
                ...
                SuggestedFileName = Path.GetFileNameWithoutExtension(_selectedFile) + "_cleaned.pdf"
            });
            ...
            if (file != null)
            {
                ...
                bool success = await _pdfService.DeletePagesAsync(
                    _selectedFile, 
                    file.Path.LocalPath, 
                    RangeInput.Text);
                ...
                if (success)
                {
                    StatusText.Text = (string)this.FindResource("Delete_Success")!;
                }
                else
                {
